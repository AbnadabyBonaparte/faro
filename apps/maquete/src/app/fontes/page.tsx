...
export default function Page() {
  return (
    ...
    <HeroPagina
      selo="PROCEDÊNCIA"
      titulo="Toda afirmação carrega a fonte e a data."
      chamada="O registro de fontes vive dentro do produto: o que foi coletado, de onde, quando, e com quanto frescor ainda serve."
      fundo="/brand/rodada-2/fundo-fontes-1920x360.svg"
    />
      <div className="mx-auto max-w-6xl space-y-6 px-4 py-8">

        <Painel>
          <PainelHead titulo="Fontes cadastradas" />
