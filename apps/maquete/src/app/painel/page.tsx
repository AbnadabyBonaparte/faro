...
export default function Page() {
  return (
    <>
    <HeroPagina
      selo="DEPOIS DA FICHA"
      titulo="A tese presta contas."
      chamada="Fichas, aprovadas, abordadas, reuniões, propostas. O funil por tese é o que separa entrega de promessa."
      fundo="/brand/rodada-2/fundo-painel-1920x360.svg"
    />
